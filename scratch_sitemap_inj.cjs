...
let newEntries = '\\n  <!-- ── Programmatic Service Locations ───────────────────────── -->\\n';
cities.forEach(city => {
  newEntries += "  <url>\\n";
  newEntries += "    <loc>https://minderfly.com/services/mobile-app-development/" + city + "</loc>\\n";
...
console.log('Added ' + cities.length + ' locations to sitemap.');
